...
//   // --- ✅ Aggregate Offer + Rating + Review JSON-LD ---
...
//   if (typeof (p as any).average_rating === 'number') {
//     jsonLd.aggregateRating = {
//       '@type': 'AggregateRating',
//       ratingValue: (p as any).average_rating.toFixed(1),
//       reviewCount: (p as any).review_count || 0,
//     };
//   }

//   // ✅ Add review if rating exists
//   if ((p as any).review_count > 0) {
//     jsonLd.review = [
//       {
//         '@type': 'Review',
//         reviewRating: {
//           '@type': 'Rating',
//           ratingValue: (p as any).average_rating?.toFixed(1) || '4.5',
//           bestRating: '5',
//         },
